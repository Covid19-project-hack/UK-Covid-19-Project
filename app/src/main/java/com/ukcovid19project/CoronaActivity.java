...
import com.ukcovid19project.Adapter.CoronaAdapter;
import com.ukcovid19project.Adapter.FAQAdapter;
import com.ukcovid19project.Models.Corona;
import com.ukcovid19project.Models.FAQ;
import com.ukcovid19project.Models.Persons;
        ...
        JsonObjectRequest request1 = new JsonObjectRequest(Request.Method.GET,url1, null,
                new Response.Listener<JSONObject>() {
                    ...
                    public void onResponse(JSONObject response) {
                        try {
                            JSONObject jsonObject = response.getJSONObject("Andaman and Nicobar Islands").getJSONObject("districtData");
